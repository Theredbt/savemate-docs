...
|---------|-----------|------|-------------|
| Any resolution | SD through 8K (480p–7680p) | 3 per day | Unlimited |
| 60fps | Any resolution | 3 per day | Unlimited |
...
<Note>
  Free users can download at any resolution, including 4K and 8K, limited to 3 downloads per day. [Professional](/billing/plans) removes the daily limit.
</Note>
