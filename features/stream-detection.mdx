...
1. **Passive monitoring** — Video Downloader Plus intercepts outgoing HTTP requests through the browser's `webRequest` APIs, watching for responses that match known video formats and MIME types.
