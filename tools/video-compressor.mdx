...
description: "Compress video files directly in your browser with Vidow. Reduce file size while preserving quality — no uploads, no server processing."
---

<Info>The video compressor is a **Professional** feature. [Upgrade your plan](/billing/plans) to access it.</Info>

The Vidow video compressor reduces video file size directly in your browser. No uploads, no waiting on a server — compression runs locally using WebAssembly.
...
| **Target file size** | Set a maximum size in MB; Vidow selects an appropriate quality level |
