...
description: "Change your password, enable two-factor authentication, and control which browser sessions have access to your Vidow account."
---
...
Pick a password that is unique to Vidow. Reusing passwords across services is the most common way accounts get compromised.
